...
document.getElementById("AG-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("AG");
});

document.getElementById("AGGA-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("AGGA");
});

document.getElementById("AGNR-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("AGNR");
});

document.getElementById("GA-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("GA");
});

document.getElementById("GAAG-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("GAAG");
});

document.getElementById("GANR-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("GANR");
});

document.getElementById("NR-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("NR");
});

document.getElementById("NRGA-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("NRGA");
});

document.getElementById("NRAG-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("NRAG");
});
